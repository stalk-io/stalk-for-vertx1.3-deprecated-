package io.stalk.mod.http.oauth.utils;

import io.stalk.mod.http.oauth.OAuthConfig;
import io.stalk.mod.http.oauth.exception.SignatureException;
import io.stalk.mod.http.oauth.exception.SocialAuthConfigurationException;
import io.stalk.mod.http.oauth.exception.SocialAuthException;
...
public class OAuthConsumer implements Serializable, Constants {
	...
	public String generateSignature(final String signatureType,
			...
			final Map<String, String> args, final AccessGrant token)
					throws Exception {
		System.out.println("Generating OAUTH Signature");
		System.out.println("Given Signature Type : " + signatureType);
		System.out.println("Given Method Type : " + method);
		System.out.println("Given URL : " + url);
		System.out.println("Given Parameters : " + args);
	...
	private String getHMACSHA1(final String method, final String url,
		...
		try {
			...
			System.out.println("Encoding raw HMAC to Base64");
	...
	public AccessGrant getRequestToken(final String reqTokenURL,
		...
		System.out.println("Preparing to get Request Token");
		System.out.println("Given Request Token URL : " + reqTokenURL);
		System.out.println("Given CallBack URL : " + callbackURL);
		...
		System.out.println(config.get_signatureMethod()
				+ " Signature for request token : " + sig);
		params.put(OAUTH_SIGNATURE, sig);
		reqURL += "?" + HttpUtil.buildParams(params);
		System.out.println("URL to get Request Token : " + reqURL);
		...
		if (response.getStatus() == 200) {
			...
			System.out.println("Error while fetching Request Token");
	...
	public AccessGrant getAccessToken(final String accessTokenURL,
		...
		System.out.println("Preparing to get Access Token");
		System.out.println("Given Access Token URL : " + accessTokenURL);
		System.out.println("Given Request Token : " + reqToken.toString());
		...
		System.out.println("Access Token URL : " + reqURL);
	...
	public String getAuthHeaderValue(final Map<String, String> params)
			throws Exception {
		System.out.println("Genrating Authorization header for given parameters : "
				+ params);
		...
		System.out.println("Authorize Header : " + headerStr.toString());
