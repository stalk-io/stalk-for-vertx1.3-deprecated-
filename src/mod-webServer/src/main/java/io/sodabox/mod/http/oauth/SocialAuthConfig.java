package io.sodabox.mod.http.oauth;
...
import io.sodabox.mod.http.oauth.utils.HttpUtil;
...
public class SocialAuthConfig {
	...
	public SocialAuthConfig() {
		...
		providersImplMap.put(Constants.FACEBOOK, io.sodabox.mod.http.oauth.provider.FacebookImpl.class);
		//		providersImplMap.put(Constants.FOURSQUARE, io.sodabox.web.auth.provider.FourSquareImpl.class);
		providersImplMap.put(Constants.GOOGLE, io.sodabox.mod.http.oauth.provider.GoogleImpl.class);
		...
		providersImplMap.put(Constants.TWITTER, io.sodabox.mod.http.oauth.provider.TwitterImpl.class);
