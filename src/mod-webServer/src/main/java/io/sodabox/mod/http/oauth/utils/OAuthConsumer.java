package io.sodabox.mod.http.oauth.utils;

import io.sodabox.mod.http.oauth.OAuthConfig;
import io.sodabox.mod.http.oauth.exception.SignatureException;
import io.sodabox.mod.http.oauth.exception.SocialAuthConfigurationException;
