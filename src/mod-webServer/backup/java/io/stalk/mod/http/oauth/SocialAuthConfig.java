package io.stalk.mod.http.oauth;

import io.stalk.mod.http.oauth.exception.SocialAuthConfigurationException;
import io.stalk.mod.http.oauth.utils.Constants;
import io.stalk.mod.http.oauth.utils.HttpUtil;
...
public class SocialAuthConfig {
	...
	public SocialAuthConfig() {
		...
		providersImplMap.put(Constants.FACEBOOK, io.stalk.mod.http.oauth.provider.FacebookImpl.class);
		//		providersImplMap.put(Constants.FOURSQUARE, io.sodabox.web.auth.provider.FourSquareImpl.class);
		providersImplMap.put(Constants.GOOGLE, io.stalk.mod.http.oauth.provider.GoogleImpl.class);
		providersImplMap.put(Constants.GOOGLEPLUS, io.stalk.mod.http.oauth.provider.GooglePlusImpl.class);
		...
		providersImplMap.put(Constants.TWITTER, io.stalk.mod.http.oauth.provider.TwitterImpl.class);
		providersImplMap.put(Constants.YAHOO, io.stalk.mod.http.oauth.provider.YahooImpl.class);
