var broadcast = function (config) {
    ...
    function openSocket() {
        ...
        $.ajax({
           type: 'GET',
            url: server.host+'/node?refer='+config.refer,
            async: false,
            ...
            success: function(json) {
               console.log(json);
               vsocket = new SockJS('http://'+json.host+':'+json.port+'/message');
               vsocket.onopen = function(e) {
                    console.log(e);
                    var reqJson = {
                        action  : "JOIN",
                        refer   : config.refer,
                    ...
                    vsocket.send(JSON.stringify(reqJson));
                };
                vsocket.onmessage = function(e) {
                    console.log(e);
                };
